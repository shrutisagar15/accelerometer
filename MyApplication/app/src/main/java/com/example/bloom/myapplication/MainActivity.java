...
public class MainActivity extends AppCompatActivity implements SensorEventListener {
    ...
    public List<Accelerometer>Data=new ArrayList<>();
    ...
    public RealMatrix GetFrameDataFromAcceData(int index,int frameSize,List<Accelerometer>data){
    ...
    public String GetStringValueFromList(List<Accelerometer>data){
        String s="";
        for (Accelerometer accelerationData:Data){
    ...
    class HandlerClass extends Handler {
        ...
        public void handleMessage(Message msg) {
            Accelerometer accelerationData=(Accelerometer )msg.obj;
            switch (msg.what) {
                case 1:
        ...
        if (capturingData && sensorEvent.sensor.getType() == Sensor.TYPE_ACCELEROMETER) {
           /* delay++;
            ...
            if (delay == 0) {
                ...
                Accelerometer accelerationData = new Accelerometer(index,sensorEvent.values[0], sensorEvent.values[1], sensorEvent.values[2],normal,filteredData);
